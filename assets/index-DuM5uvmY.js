                ...
                <div id="screen-task" class="p-6 sm:p-8">
                    ...
                    <div class="bg-purple-50/50 rounded-2xl p-5 sm:p-6 mb-6 border border-purple-100">
                        ...
                        <div class="space-y-3 text-purple-950 text-base leading-relaxed">
                            <p>Você é assinante da plataforma de streaming <strong>Radiant Plus</strong> há cerca de 6 meses. No entanto, você está fazendo um corte de gastos nas suas finanças pessoais este mês.</p>
